...
public class VentanaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        eiquetaNombre1 = new javax.swing.JLabel();
        ...
        etiquetaTitulo.setFont(new java.awt.Font("Cambria", 0, 40)); // NOI18N
        etiquetaTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiquetaTitulo.setText("Ta-Te-Ti");
        panel.add(etiquetaTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 15, 702, -1));

        eiquetaNombre1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        eiquetaNombre1.setText("Digite el nombre del usuario 1:");
        panel.add(eiquetaNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 96, -1, -1));

        etiquetaNombre2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        etiquetaNombre2.setText("Digite el nombre del usuario 2:");
        panel.add(etiquetaNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 147, -1, -1));

        cajaNombre1.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        cajaNombre1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaNombre1ActionPerformed(evt);
            }
        });
        panel.add(cajaNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(287, 92, 344, 32));

        cajaNombre2.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        panel.add(cajaNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(287, 139, 344, 32));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/tateti.gif"))); // NOI18N
        panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(391, 177, 311, 337));

        etiquetaMuestra1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        panel.add(etiquetaMuestra1, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 328, -1, 30));

        etiquetaMuestra2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        panel.add(etiquetaMuestra2, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 366, -1, 40));

        botonGuardar.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        ...
        panel.add(botonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 120, 46));
        ...
        panel.add(botonComenzarJuego, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 450, -1, 45));
    ...
    private javax.swing.JLabel eiquetaNombre1;
